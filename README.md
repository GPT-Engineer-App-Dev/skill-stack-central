...
When clikcing ona. developer, you shoul see their detaisl page and be able to mesage them 
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/skill-stack-central.git
cd skill-stack-central
npm i
```
